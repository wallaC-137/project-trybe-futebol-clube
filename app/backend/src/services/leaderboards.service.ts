import LeaderboardModel from '../models/leaderboards.model';
...
export default class LeaderboardService {
  ...
  public async getAllHostInfos(): Promise<ServiceResponse<ILeaderboards[]>> {
    const allMatches = await this.leaderboardModel.getAllHostInfos();
